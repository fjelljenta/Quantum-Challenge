...
# Max deviation (along y) away from straight line solution
max_dev = 20
...
def Fitness_evaluation(flight_nr, generation):
    ...
    for i in range(1, popSize):
        ...
        trajectory = toolbox.curve_3D_trajectory_core(
            flight_nr, curve_xy, curve_z, 0.3)
        # - because we want to minimalize the cost
        fitness[i] = -toolbox.compute_cost({"trajectory": trajectory})
